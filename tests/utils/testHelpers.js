 ...
 */
export function createMockTouchEvent(type = 'touchstart', overrides = {}) {
    return {
        type,
        preventDefault: jest.fn(),
        stopPropagation: jest.fn(),
 ...
 */
export function getSVGElementByClass(container, className) {
 ...
 */
export function getAllSVGElementsByClass(container, className) {
 ...
 */
export function expectSVGElement(container, selector) {
