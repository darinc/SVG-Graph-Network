...
describe('Vector', () => {
    ...
    describe('magnitude', () => {
        ...
        test('should handle floating point coordinates', () => {
            const vector = new Vector(1.5, 2.0);
            expect(vector.magnitude()).toBeCloseTo(2.5);
        });
    ...
    describe('normalize', () => {
        ...
        test('should throw error for zero vector', () => {
            const vector = new Vector(0, 0);
            expect(() => vector.normalize()).toThrow('Cannot normalize zero vector');
        });
    ...
    describe('distance', () => {
        ...
        test('should handle floating point coordinates', () => {
            const v1 = new Vector(1.5, 2.0);
            const v2 = new Vector(4.5, 6.0);
            
            expect(Vector.distance(v1, v2)).toBeCloseTo(5);
        });
    });
    ...
    describe('edge cases', () => {
        test('should handle very large numbers', () => {
            ...
            expect(vector.magnitude()).toBeCloseTo(Math.sqrt(2) * 1e10);
        });

        test('should handle very small numbers', () => {
            const vector = new Vector(1e-10, 1e-10);
            expect(vector.magnitude()).toBeCloseTo(Math.sqrt(2) * 1e-10);
        });
