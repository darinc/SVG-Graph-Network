...
describe('PhysicsEngine', () => {
    ...
    let links: Array<{ source: Node<NodeData>; target: Node<NodeData> }>;
    ...
    describe('updatePositions', () => {
        ...
        test('should apply damping to velocity', () => {
            ...
            expect(newSpeed).toBeCloseTo(initialSpeed * (engine as any).config.damping);
        });
        ...
        test('should integrate forces into velocity correctly', () => {
            ...
            const expectedVelocityX = (5 + 20) * (engine as any).config.damping;
            const expectedVelocityY = (10 + 30) * (engine as any).config.damping;
    ...
    describe('force calculations edge cases', () => {
        ...
        test('should handle empty nodes and links', () => {
            ...
            const emptyLinks: Array<{ source: Node<NodeData>; target: Node<NodeData> }> = [];
